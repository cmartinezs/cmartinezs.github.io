...
export const experienceItems: ExperienceItem[] = [
  {
    ...
    learning:
      "Enseñar obliga a ordenar el conocimiento, explicar con claridad y volver a los fundamentos sin perder conexión con la industria.",
  },
  {
  ...
  },
  {
    ...
    learning:
      "A escala, el buen software depende tanto del código como del entendimiento del dominio, los datos, los límites y la comunicación entre equipos.",
  },
  {
    id: "diseno-software",
    ...
    learning:
      "La arquitectura también se enseña y se conversa; documentar, revisar y alinear criterios es parte central del trabajo técnico.",
  },
  {
    ...
    learning:
      "En entornos regulados, la calidad no es un extra; es parte del producto y debe estar presente desde el análisis hasta la entrega.",
  },
  {
    id: "modernizacion",
    badge: "Modernización",
    ...
    learning:
      "Modernizar no significa borrar todo; muchas veces el valor está en entender lo existente y evolucionarlo de forma segura.",
  },
  {
    id: "base-profesional",
    ...
    learning:
      "La versatilidad técnica se construye enfrentando problemas distintos y aprendiendo a adaptarse sin perder buenas prácticas.",
  },
];
